    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False, verbose_name='Является ли администратором')),
                ('is_superuser', models.BooleanField(default=False, verbose_name='Является ли суперпользователем')),
